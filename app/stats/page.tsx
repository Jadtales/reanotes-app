...
export default function StatsPage(): ReactElement<any> {
  ...
  return (
    <div className='statsPageContainer'>
      {isInPhoneSize && (
        <GoBackToComponent withText={true} margin={'0 0'} iconSize={'25px'} />
      )}
      <div className='userOverviewStats'>
        ...
        <div className='statsResult'>
          ...
          <OverviewStats
            typeOfStatsContent={'Reviewed cards'}
            statsResult={232}
          />
          <OverviewStats
            typeOfStatsContent={'Readnotes Ranking'}
            statsResult={99}
          />
          <OverviewStats
            typeOfStatsContent={'Average Rating'}
            statsResult={99}
          />
          <OverviewStats
            typeOfStatsContent={'Most Viewed Genre'}
            statsResult={'#Fiction'}
          />
        </div>
      </div>
