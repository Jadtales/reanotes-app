...
import MoveToFolderModal
    from "@/app/compos/modals/notecard-settings-modals/move-notecard-modal/move-to-folder-modal";
...
import ExportNotecardModal
    from "@/app/compos/modals/notecard-settings-modals/export-notecard-highlights-modal/ExportNotecardModal";
        ...
        <Fragment>
            ...
            <dialog className={!isInPhoneSize ? 'frontNoteSettingContainer' : 'frontNoteSettingContainer-phoneSize'}
                ...
                <ul>
                    ...
                    <MoveToFolderModal isPhoneSize={isInPhoneSize} notecardCredentials={{bookId, bookTags}}/>
                    <ExportNotecardModal isPhoneSize={isInPhoneSize} bookCredentials={bookCredentials} />
