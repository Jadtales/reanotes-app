      ...
      <div className='settingsPageContainer'>
        <div className='settingsTarget'>
          ...
          <ul>
            <li
              className={
                chosenSettings === 'general' ? 'settingsTargetLi-active' : ''
              }
              onClick={() => handleChosenSettings('general')}
            >
              General
            </li>
            <li
              className={
                chosenSettings === 'myProfile' ? 'settingsTargetLi-active' : ''
              }
              onClick={() => handleChosenSettings('myProfile')}
            >
              My Profile
            </li>
          </ul>
        ...
        {chosenSettings === 'general' ? (
          ...
          <div className='userProfileAdjustments'>
            <div className='userCredentials'>
              ...
              <h2 className='userUsername'>@jadtales</h2>
